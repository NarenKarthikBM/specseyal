...
> `type` value (`refactor`) that is not one of the closed 8 (taxonomy-v0.md §2);
> T002 carries a `specialization` value (`frontend-mobile`) that is not one of the
> closed 11 (taxonomy-v0.md §4). Neither value is a typo of a real enum member —
...
|---|---|---|---|---|
| T001 | `refactor` | `devtools-cli` | false | test |
| T002 | `service` | `frontend-mobile` | false | test |
