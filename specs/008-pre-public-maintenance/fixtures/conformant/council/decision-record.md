...
|---|---|---|---|---|---|
| R1-S01 | consider | Name the fixture more descriptively than `conformant` | rejected | The directory name is fixed by the T007 fixture-authoring brief (`specs/008-pre-public-maintenance/tasks.md`), which this council has no standing to overrule. | — |
