...
- [X] T019 Run the `quickstart.md` validation scenarios (SC-001…SC-010 map). SC-009 (M4 exit — validated report + testing doc, both committed) and SC-010 (wave 2+ unassisted freshness) are proven on **M4's own downstream run**, not simulated here. (depends on T018)
